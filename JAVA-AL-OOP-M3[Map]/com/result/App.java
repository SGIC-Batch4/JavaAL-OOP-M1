...
public class App {
	...
	public static void main(String[] args) {
		...
		subjectStore.addSuject(new Subject("S001","ComMath"));
		subjectStore.addSuject(new Subject("S002","Biology"));
		subjectStore.addSuject(new Subject("S003","Physics"));
		subjectStore.addSuject(new Subject("S004","chemtry"));
		...
		alRes1.addMarks("S001", 78.0);
		alRes1.addMarks("S004", 67.0);
		alRes1.skipSubjectForTotal("C001");
		alRes1.skipSubjectForTotal("C002");
		alRes1.printResult();
		...
		alRes2.skipSubjectForTotal("C001");
		alRes2.skipSubjectForTotal("C002");
		alRes2.printResult();
	}
